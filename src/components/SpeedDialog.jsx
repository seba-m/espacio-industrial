                    ...
                    <SpeedDial placement="top">
                        ...
                        <SpeedDialContent>
                            <SpeedDialAction onClick={handleHome}>
                                ...
                                <Typography {...labelProps}>Ir al inicio</Typography>
                            </SpeedDialAction>
                            <SpeedDialAction onClick={() => setOpenFeedback(true)}>
                                <ChatBubbleBottomCenterIcon className="h-5 w-5" />
                                <Typography {...labelProps}>Enviar comentarios</Typography>
                            </SpeedDialAction>
                            <SpeedDialAction onClick={() => setOpenHelp(true)} className="ml-2">
                                <QuestionMarkCircleIcon className="h-5 w-5" />
                                <Typography {...labelProps}>Ayuda</Typography>
                            </SpeedDialAction>
                        </SpeedDialContent>
                    </SpeedDial>
                </div>
