...
export default function Search() {
    ...
    useHotkeys(keyMap.SEARCH_CLEAR, (e) => {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
        setSearch('');
    ...
    useHotkeys(keyMap.SEARCH_PREV, (e) => {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
    ...
    useHotkeys(keyMap.TOGGLE_FUERA_FAENA, (e) => {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
    ...
    useHotkeys(keyMap.TOGGLE_DENTRO_FAENA, (e) => {
        e.preventDefault();
        e.stopPropagation();
        e.stopImmediatePropagation();
